		...
		<div class="foot-btn">
			<ul>
		    	...
		    	<li class="xing"><a href="javascript:;">
		        	<i><img src="../../static/img/xing.png" alt=""/></i>
		        </a></li>
		    	<li class="fx"><a href="javascript:;">
		        	<i><img src="../../static/img/fx.png" alt=""/></i>
		        </a></li>
		    </ul>
		</div>
	</div>
...
<style scoped>
	...
	.nav ul li{width:0.29rem;height:0.31rem; background:url(../../static/img/history.png) no-repeat 0 0; background-size:100%; margin:0 0 0 0.38rem;}
	...
	.say i{width:0.36rem;height:0.26rem; background:url(../../static/img/say.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.7rem; margin-top:0.13rem;}
	...
	.zan i{width:0.36rem;height:0.28rem; background:url(../../static/img/zan1.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.54rem; margin-top:0.13rem;}
